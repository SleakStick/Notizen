...
\begin{tabular}{|p{4cm}|p{4cm}|}
  \hline
  WiderStand& \[V_R=-IR\]\\\hline
  Capazität & \[V_C= \frac{Q}{C}\]\\\hline
  Spule & \[V_L = -L \frac{dI}{dt}\]\\\hline
\end{tabular}
\end{centering}
...
Bei diesem Fall ist $\alpha$ von $\omega$ abhängig ist.
 

Wenn wir $I/\omega/\omega_0$ plotten, dann bekommen wir eine Resonanz kurve, also wenn wir mit dei Resonanzfrequenz des Schaltkreises die Wechselstromquelle stellen, dann ist der Strom maximal. Die leistung ist auch so eine Kurve
