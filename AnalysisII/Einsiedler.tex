...
\definition{} Eine Funktion $f:X\rightarrow Y$ heisst gleichmässig stetig falls $\foralla \varepsilon >0$ $\exists \delta > 0$ so dass $\forall x_0,x_1\in X$ gilt $d(x_0,x_1)<\delta\Rightarrow d(f(x_0),f(x_1))<\varepsilon$
\end{document}
