...
\end{itemize}
\definition{Abgeschloffene Mengen}Sei $X$ ein Metrischer Raum, Eine Menge $B\subset X$ heisst abgeschloffen (clopen) falls die Menge Abgeschlossen und Offen in $X$ ist.
